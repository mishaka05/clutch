...
export default function TaskCard({ task, isLarge = false, onSelect, onTriggerCrisis }: TaskCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`
        relative overflow-hidden rounded-xl bg-[#0F1D30] border border-[#1A2E46] p-5 cursor-pointer flex flex-col justify-between h-full
      ...
      <div className="space-y-3.5">
        ...
        <div className="flex justify-between items-center pt-2 border-t border-[#1C2F46]/50">
          ...
          <button
            ...
            className="flex items-center gap-1 text-[11px] font-space font-bold uppercase tracking-wider text-[#00D4FF] hover:text-white transition-colors cursor-pointer"
          >
            Open detail
